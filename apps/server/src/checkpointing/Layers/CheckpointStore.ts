...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "kodo-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Kodo Code",
          GIT_AUTHOR_EMAIL: "kodocode@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Kodo Code",
          GIT_COMMITTER_EMAIL: "kodocode@users.noreply.github.com",
        };
        ...
        const message = `kodo checkpoint ref=${input.checkpointRef}`;
